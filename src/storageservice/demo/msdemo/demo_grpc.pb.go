...
type StorageServiceClient interface {
	SaveAudit(ctx context.Context, in *SaveAuditRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *storageServiceClient) SaveAudit(ctx context.Context, in *SaveAuditRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/msdemo.StorageService/SaveAudit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StorageServiceServer interface {
	SaveAudit(context.Context, *SaveAuditRequest) (*Empty, error)
}
...
func (UnimplementedStorageServiceServer) SaveAudit(context.Context, *SaveAuditRequest) (*Empty, error) {
...
func _StorageService_SaveAudit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SaveAuditRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageServiceServer).SaveAudit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/msdemo.StorageService/SaveAudit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageServiceServer).SaveAudit(ctx, req.(*SaveAuditRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StorageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "msdemo.StorageService",
	HandlerType: (*StorageServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SaveAudit",
			Handler:    _StorageService_SaveAudit_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "demo.proto",
